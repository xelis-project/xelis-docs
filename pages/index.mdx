...
**BlockDAG** is used to improve the scalability and the security of the network.<br/>
...
**P2P Encrypted Network** is used to prevent any network traffic analysis and to provide better privacy.
All messages between nodes are encrypted with ChaCha20-Poly1305. Messages keys are rotated every GB of data. 
