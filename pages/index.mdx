...
**XELIS** is an innovative cryptocurrency built from scratch with a focus on privacy, scalability, and ease of use.
...
Smart Contracts on XELIS will be powered by a new Virtual Machine named XVM, which is built froms cratch for ease of use, performance and security.
