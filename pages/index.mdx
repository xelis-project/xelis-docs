...
<Cards>
  <Card title="Mainnet" subtitle="Mainnet scheduled to April 20, 2024." href="#" />
...
There are multiple reasons why we opted for a decreasing fee curve, but one amongs others, is to prevent big miners from earning 
