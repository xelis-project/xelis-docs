...
For developers that want to contribute and needs fast building, they can use debug mode.

### Run it

Now that you have successfully build the software, see [Configuration](/getting-started/configuration).
</Steps>