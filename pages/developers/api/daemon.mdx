...
```json
{
	...
	"jsonrpc": "2.0",
	"result": [{
        "addr": "95.214.55.65:2125",
        "cumulative_difficulty": 16248916130966,
        "height": 498023,
        "id": 2491091954271682000,
        "last_ping": 1697749917,
        "pruned_topoheight": 498960,
        "tag": null,
        "top_block_hash": "000000175bc2aadcddefc4faafb62aefb21da802d16115767e1b8e87245efcb4",
        "topoheight": 499055,
        "version": "1.5.0"
    }]
}
...
> When a peer connected with the node.

### `PeerDisconnected`

> When a peer disconnected from the node.
...
> When a peer from the peer list disconnected.
