...
The data stored on the network is encrypted and can be shared with other users or kept private.
...
For exchanges, having a way to identify easily a deposit is also a good way to have a better user experience.
