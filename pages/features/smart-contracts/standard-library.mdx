...
- [12. MemoryStorage Functions](#12-memorystorage-functions)
  ...
  - [load](#load-memory-storage)
  - [has](#has-memory-storage)
  - [store](#store-memory-storage)
  - [delete](#delete-memory-storage)
...
- [18. Misc. Built-ins](#18-misc-built-ins)
...
### transfer_ownership
```silex
asset.transfer_ownership(contract) -> bool
```
**Gas Cost**: 250  
