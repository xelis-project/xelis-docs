...
- [7. Integer Functions & Constants](#7-integer-functions--constants)
  - [Overflowing Arithmetic](#checked-arithmetic)
  - [MIN, MAX constants](#min-max-constants)
  - [to_be_bytes / to_le_bytes](#to_be_bytes--to_le_bytes)

- [8. Transaction Functions](#8-transaction-functions)
...
- [9. Block Functions](#9-block-functions)
...
- [10. Storage Functions](#10-storage-functions)
...
- [11. ReadOnlyStorage Functions](#11-readonlystorage-functions)
...
- [12. MemoryStorage Functions](#12-memorystorage-functions)
...
- [15. Random Functions](#15-random-functions)
...
- [16. Signature Functions](#16-signature-functions)
  - [verify](#verify)
  - [Signature::from_bytes](#signaturefrom_bytes)

- [17. Asset Functions](#17-asset-functions)
...
- [18. Misc. Built-ins (No Specific Opaque)](#18-misc-built-ins-no-specific)
