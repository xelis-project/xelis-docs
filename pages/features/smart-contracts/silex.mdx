...
## Table of Contents
- [Silex Language Documentation](#silex-language-documentation)
  ...
  - [Functions](#functions)
    ...
    - [Methods on Structs/Enums](#methods-on-structsenums)
  - [Structs](#structs)
  - [Enums](#enums)
  - [Imports](#imports)
...
Every Silex contract may optionally define an *entry* function—this serves as the main entry point for external invocations.
