...
This address is used to send and receive transactions, solo mine, see the history on explorer or to simply communicate with him on-chain.
...
The data can be of any type and support JSON encoding/decoding for easy manipulation.
...
The data included in an integrated address is limited to 1 KiB only.
