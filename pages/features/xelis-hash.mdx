...
To do so, we try to keep the CPUs and GPUs in the game together, and to avoid the use of efficient FPGAs or ASICs by having a memory-hard algorithm.
...
- Memory-hard: Being bottlenecked by memory access rather than computation
