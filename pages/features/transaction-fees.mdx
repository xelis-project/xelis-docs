...
A fee system is necessary for security and to balance fees correctly between the needs of low cost for users using the chain daily, but high enough to prevent bad actors
from anormal usage.
