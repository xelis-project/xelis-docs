...
The return type is optional but is set by default to `u64` to indicate success (0) or failure (non-zero).
It can be set to any type, this will lead to the return value being stored in the contract logs of the execution.
