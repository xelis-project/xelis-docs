...
|---------|------------|--------------|-----------------------------------|-----------------------------------|
| V4      | 2024-12-18 | 3 357 500    | Bug fixes, DAG improvements       | [More Info](#v4)                  |
...
Smart Contracts, 5s block time, new dynamic base fee system, and PoW V3 for a better egalitarian algorithm.
