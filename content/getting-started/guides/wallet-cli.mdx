...
If you don't have one, please follow the [Build from sources](/getting-started/build-from-source-code) page.
...
Now you are in your wallet and you can start using it. This will print 25 words representing your seed phrase. **Please write them down and keep them safe.**

After writing down your seed, press ENTER to make it disappear from the screen.
