...
If you don't have one, please follow the [Create your wallet using CLI](/getting-started/guides/wallet-cli) page.
...
Or you can check the [documentation](/getting-started/configuration/xelis_miner) for more details.
